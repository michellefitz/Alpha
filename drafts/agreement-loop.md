...
But we've had twenty years to get savvy about recommendations when they were objects. We know search rankings aren't neutral, we skip the sponsored results, we don't assume the recommended product is the best one. An AI recommends something subtler: judgement. A framing, a strategy, a prioritisation. We haven't built the instincts yet for treating a recommended judgement as a suggestion rather than a conclusion.
...
All of this matters more the more you let the AI drive. The push right now is toward autonomy: give the AI a bigger objective and a way to measure it, then let it run and come back when it's done. In that world you don't get turn-by-turn feedback, and you can't review each small decision as it's made. The AI can produce ten times the work; you can't judge it ten times faster. The agreement loop doesn't go away. It concentrates into the two moments you're still in the room: the brief at the start, and the review at the end.

I feel it already when I'm building. The AI writes the whole feature now, along with a long explanation of what it did and why. I catch myself accepting the lot — I'll look properly later, I'll decide later — and by the time I do, I'm anchored on what it built. The review I meant to do has quietly turned into a rubber stamp.
...
The AI is going to do more and more of the work. Little by little, if you let it, it will also start deciding what counts as good, and you'll agree the whole way. So what's your part in all of this? Deciding what good looks like — and being able to explain why.
